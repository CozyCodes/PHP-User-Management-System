...
// $i = mysql_query("update student_admin set stud_admin_email='".$_POST['txtemail']."', stud_admin_address='".trim($_POST['txtaddress'])."', stud_admin_phone='".$_POST['txtphone']."' where stud_admin_uname=".$_SESSION['name1']);
	$i  =   mysql_query("UPDATE student set stud_name='". $name."',stud_address='". $address."',stud_phone='". $phone."' WHERE stud_username='".$_SESSION["name"]."'");
...
<center>
      <form action="" method="post" enctype="multipart/form-data">
		...
		<tr>
				...
				// echo $eid;
					include ("connect.php");
					$g = mysql_query("select * from student WHERE stud_username = '".$_SESSION['name']."'");
