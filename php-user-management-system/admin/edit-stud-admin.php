...
//		move_uploaded_file($_FILES['file']['tmp_name'],'img/'.$store);
	   $i = mysql_query("update student_admin set stud_admin_name='".$_POST['txtname']."', stud_admin_email='".$_POST['txtemail']."', stud_admin_address='".trim($_POST['txtaddress'])."', stud_admin_phone='".$_POST['txtphone']."' where stud_admin_id=".$id);
