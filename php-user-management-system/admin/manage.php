...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="addnew" href="student-add.php" style="font-face:Khmer OS Battambang; font-size:16px;"><b>Add Student</b></a></font>
	...
	<table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td><?php echo $tr[6]; ?></td>
			<td><?php echo $tr[9]; ?></td>
            <td align="center"><a href="delete-user.php?txtid=<?php echo $tr[0];?>&txtname=<?php echo $tr[1];?>">Delete</a> / <a href="edit-user.php?txtid=<?php echo $tr[0];?>">Edit</a> / <a href="status.php?txtid=<?php echo $tr[0];?>">Status</a> </td>    
        </tr>
        <?php
			}
		?>
