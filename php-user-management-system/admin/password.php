...
<div id="body">
	 ...
	 // echo $_SESSION['name2'];
	 ?>
	<a href="reset-student-password.php" class="btn btn-info" role="button">RESET STUDENT PASSWORD</a>
	
</div>
<div id="body">
	
	<a href="reset-student-admin-password.php" class="btn btn-info" role="button">RESET STUDENT ADMIN PASSWORD</a>
