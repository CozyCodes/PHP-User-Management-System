...
<div id="body">
	 ...
	 // echo $reset;
	 ?>
	<a href="student-add.php" class="btn btn-info" role="button">REGISTER STUDENT & STUDENT ADMIN</a>
...
<div id="body">
	...
	<a href="manage.php" class="btn btn-info" role="button">MANAGE STUDENT USER</a>
	
</div>
<div id="body">
	
	<a href="manage-stud-admin.php" class="btn btn-info" role="button">MANAGE STUDENT ADMIN</a>
